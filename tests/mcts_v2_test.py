...
class NodeTest(parameterized.TestCase):
    def setUp(self):
        ...
        self.root_node = mcts.Node(num_actions=self.num_actions, parent=mcts.DummyNode())
...
class ExpandNodeTest(parameterized.TestCase):
    ...
    def test_expand_node(self):
        root_node = mcts.Node(num_actions=self.num_actions, parent=mcts.DummyNode())
    ...
    def test_node_expand_invalid_type(self):
        dummy = [0.1, 3.3, {}, []]
        root_node = mcts.Node(num_actions=self.num_actions)
...
class MCTSUpdateStatisticsTest(parameterized.TestCase):
    ...
    def test_update_statistics_level_1_mixed(self):
        ...
        child_0 = root_node.children[0] = mcts.Node(self.num_actions, 0, root_node)
        child_1 = root_node.children[1] = mcts.Node(self.num_actions, 1, root_node)
        child_2 = child_0.children[0] = mcts.Node(self.num_actions, 0, child_0)
        child_3 = child_0.children[1] = mcts.Node(self.num_actions, 1, child_0)
    ...
    def test_update_statistics_level_2(self):
        ...
        child_0 = root_node.children[0] = mcts.Node(self.num_actions, 0, root_node)
        child_1 = child_0.children[0] = mcts.Node(self.num_actions, 0, child_0)
        child_2 = child_1.children[0] = mcts.Node(self.num_actions, 0, child_1)
        child_3 = child_1.children[1] = mcts.Node(self.num_actions, 1, child_1)

        mcts.backup(child_0, 0.6)

        mcts.backup(child_1, -0.8)

        mcts.backup(child_2, 1.0)

        mcts.backup(child_3, 2.0)
...
class MCTSGeneratePlayPolicyTest(parameterized.TestCase):
    ...
    def test_play_policy_root_node_greedy_equal_prob(self):
        ...
        child_0 = root_node.children[0] = mcts.Node(self.num_actions, 0, root_node)
        child_1 = root_node.children[1] = mcts.Node(self.num_actions, 1, root_node)
        child_2 = root_node.children[2] = mcts.Node(self.num_actions, 2, root_node)
        child_3 = root_node.children[3] = mcts.Node(self.num_actions, 3, root_node)
